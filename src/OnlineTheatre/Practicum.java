...
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            printMenu();
            // Считайте команду, введенную пользователем - done
            ...
            if (command == 1) {
                ...
                // На основе введенных пользователем значений создайте объект класса Movie - done
                ...
                // Создайте сериал и добавьте его в список просмотренных - done
    ...
    public static void printMediaItemsList(List<MediaItem> mediaItems) {
        ...
        // Допишите вывод названий всех просмотренных фильмов и сериалов - done
